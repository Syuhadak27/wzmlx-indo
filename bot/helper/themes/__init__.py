...
from bot.helper.themes import wzml_minimal, wzml_icon, wzml_hide, wzml_ori, wzml_terbaru, wzml_latest

AVL_THEMES = {"minimal": wzml_minimal, "icon": wzml_icon, "terbaru": wzml_terbaru,"latest": wzml_latest, "ori": wzml_ori, "hide": wzml_hide}
